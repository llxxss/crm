...
<body>
	...
	<div class="button_bar">
		<button class="common_button"
			onclick="window.location.href='${ctp}/storage/'">
			库存添加
		</button>
			...
			<c:forEach var="storage" items="${page.content }">
				<tr>
					...
					<td class="list_data_op">
						<img onclick="window.location.href='${ctp}/storage/${storage.id }'" 
							title="修改" src="${ctp }/static/images/bt_edit.gif" class="op_button" />
						<img onclick="window.location.href='${ctp}/storage/${storage.id }?_method=DELETE'" 
