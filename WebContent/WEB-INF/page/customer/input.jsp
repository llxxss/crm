			...
			<tr>
				...
				<td>
					<form:select path="region">
						<form:option value="">${customer.region }</form:option>
				...
				<td>
					<form:select path="manager.id">
						<form:option value="">${customer.manager.name }</form:option>
			...
			<tr>
				...
				<td>
					<form:select path="satify">
						<form:option value="">${customer.satify }</form:option>
				...
				<td>
					<form:select path="credit">
						<form:option value="">${customer.credit }</form:option>
